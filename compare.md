...
/bin/bash: line 2: 430506 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
...
PASS: 088_hanoi
/bin/bash: line 2: 431029 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
...
/bin/bash: line 2: 431151 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
...
PASS: 103_long_func
PASS: 104_long_array
/bin/bash: line 2: 431308 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
...
/bin/bash: line 2: 431687 Segmentation fault      timeout 10s ${BIN} < ${IN} > ${RES} 2>> ${LOG}
...
FAIL: lisp1     Wrong Answer
FAIL: lisp2     Wrong Answer
FAIL: rbtree_in_segtree Assemble Error
FAIL: splay     Assemble Error
Total: 100      Accept: 65      Fail: 35