...
/bin/bash: line 2: 830673 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
...
FAIL: 073_backpack      Wrong Answer
FAIL: 078_big_int_mul   Wrong Answer
PASS: 079_calculator
FAIL: 080_color Assemble Error
PASS: 081_exgcd
PASS: 083_brainfk
/bin/bash: line 2: 831104 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
FAIL: 084_expr_eval     Compile Error
PASS: 085_dijkstra
FAIL: 086_full_conn     Compile Error
PASS: 088_hanoi
/bin/bash: line 2: 831150 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
...
/bin/bash: line 2: 831245 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
FAIL: 096_side_effect   Compile Error
/bin/bash: line 2: 831248 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
...
PASS: 101_scope2
/bin/bash: line 2: 831323 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
FAIL: 102_short_circuit3        Compile Error
PASS: 103_long_func
PASS: 104_long_array
/bin/bash: line 2: 831359 Segmentation fault      timeout 60s build/compiler ${file} -o ${IR} -i 2> ${LOG}
...
/bin/bash: line 2: 831714 Segmentation fault      timeout 10s ${BIN} < ${IN} > ${RES} 2>> ${LOG}
FAIL: 10_DFS    Wrong Answer
PASS: 110_many_params3
PASS: 111_many_globals
FAIL: 112_many_locals   Wrong Answer
...
FAIL: lisp1     Assemble Error
FAIL: lisp2     Assemble Error
FAIL: rbtree_in_segtree Assemble Error
FAIL: splay     Assemble Error
Total: 100      Accept: 52      Fail: 48